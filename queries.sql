...
INSERT INTO lot
(name, description, img_path, starting_price, completion_date, bid_step, category_id, user_id)
    VALUES ("2014 Rossignol District Snowboard",
            ...
            "img/lot-1.jpg", 10999, "2019-04-26 05:48:05", 300, 1, 1),
    ("DC Ply Mens 2016/2017 Snowboard",
     ...
     "img/lot-2.jpg", 159999, "2019-04-26 05:48:05", 450, 1, 2),
    ...
    ("Куртка для сноуборда DC Mutiny Charocal",
     ...
     "img/lot-5.jpg", 7500, "2019-04-26 09:48:05", 250, 4,
     1),
    ("Маска Oakley Canopy",
     ...
     "img/lot-6.jpg", 5400, "2019-05-25 05:48:05", 100, 6, 2);
...
SELECT lot.name AS lot_name, starting_price, img_path, category.name AS category_name, starting_price AS price
FROM lot
         JOIN category
