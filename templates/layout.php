...
<div class="page-wrapper">
    ...
    <header class="main-header">
        <div class="main-header__container container">
            ...
            <a class="main-header__logo"<?php if ($title !== "Главная"): ?> href="/index.php"<?php endif; ?>>
                <img src="../img/logo.svg" width="160" height="39" alt="Логотип компании YetiCave">
            </a>
            <form class="main-header__search" method="get" action="/search.php" autocomplete="off">
                <input type="search" name="search"
                       placeholder="Поиск лота"<?php if (isset($search)): ?> value="<?= htmlspecialchars($search); ?>"<?php endif; ?>>
            ...
            <nav class="user-menu">
                <?php if ($user_session['is_auth'] === 1): ?>
                    <div class="user-menu__logged">
                        <p><?= htmlspecialchars($user_session['name']); ?></p>
