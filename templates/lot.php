                ...
                <div class="lot-item__state">
                    ...
                    <div class="lot-item__cost-state">
                        <div class="lot-item__rate">
                            ...
                            <span class="lot-item__cost"><?= format_cost_for_bids_block($current_lot["current_price"]); ?></span>
                        </div>
                        <div class="lot-item__min-cost">
                            Мин. ставка
                            <span><?= format_cost_for_bids_block($current_lot["min_bid"]); ?> р</span>
                        </div>
                    </div>
                    <form class="lot-item__form" action="<?= "/lot.php?id=" . $_GET['id']; ?>" method="post"
                        ...
                        <p class="lot-item__form-item form__item<?= $new_bid_adding["form_error_class"]; ?>">
                            ...
                            <input id="cost" type="text" name="cost"
                                   placeholder="<?= format_cost_for_bids_block($current_lot["min_bid"]); ?>">
